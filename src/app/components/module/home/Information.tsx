        ...
        <div className="flex flex-col lg:flex-row gap-6 mb-12">
          ...
          <div className="flex flex-col justify-end">
            ...
            <p className="text-muted-foreground max-w-2xl">
              ...
              learning, hands-on activities, and personalized attention, we help
              children build a strong foundation for lifelong learning.
            </p>
          </div>
        </div>
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4 ">
          {cards.map((card, idx) => (
            <Link
              key={idx}
              href={card.link}
              className="flex flex-col items-center p-6 bg-card text-card-foreground rounded-xl shadow-md hover:shadow-xl transition-shadow duration-300"
            >
